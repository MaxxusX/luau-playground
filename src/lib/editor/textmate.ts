...
function tokenStyle(token: string | null): string | null {
	...
	switch (token) {
		...
		case "bool":
		case "atom":
			return `color: ${palette.bool}`;
		case "typeName":
			return `color: ${palette.typeName}`;
		case "variableName.function":
			return `color: ${palette.func}`;
		case "variableName":
			return `color: ${palette.variable}`;
		case "operator":
			return `color: ${palette.operator}`;
		case "punctuation":
			return `color: ${palette.punctuation}`;
		case "comment":
			return `color: ${palette.comment}; font-style: italic`;
		default:
			return null;
	}
}
