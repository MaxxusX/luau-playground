...
>
	<div class="space-y-4">
		...
		<div class="space-y-2">
			...
			<pre
				class="w-full rounded-md border border-(--border-color) bg-(--bg-editor) p-3 text-xs text-(--text-secondary) font-mono whitespace-pre-wrap break-all leading-relaxed">{embedCode}</pre>
			<Button
				size="sm"
